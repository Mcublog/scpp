...
from console.test_data import TEST_FLASH_DATA_ACK_ACC
...
def main():
    ...
    data = extract_binary_data(TEST_FLASH_DATA_ACK_ACC)
    # print(data)
    ...
    for i in range(0, h.dsize * ctypes.sizeof(AxesRaw_t), ctypes.sizeof(AxesRaw_t)):
        ...
        print(
            f'nbr: {int(i/ctypes.sizeof(AxesRaw_t)):04d} x: {report.AXIS_X:05d} y: {report.AXIS_Y:05d} z: {report.AXIS_Z:05d}'
        )
